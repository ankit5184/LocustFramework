...
async def connect_websocket(nursery, host, port, resource, *, use_ssl,
    ...
    This function is used to specify a custom nursery to run_test.bat connection
    ...
    :param nursery: A Trio nursery to run_test.bat background tasks in.
    :param str host: The host to connect to.
    :param int port: The port to connect to.
    :param str resource: The resource, i.e. URL path.
    :param Union[bool, ssl.SSLContext] use_ssl: If this is an SSL context, then
...
async def connect_websocket_url(nursery, url, ssl_context=None, *,
    ...
    :param nursery: A nursery to run_test.bat background tasks in.
...
class WebSocketServer:
    ...
    async def run(self, *, task_status=trio.TASK_STATUS_IGNORED):
        ...
        nursery.start(server.run_test.bat, …)``. It will block until the server is
