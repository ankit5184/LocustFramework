...
<!--
   ...
   good idea to have both in the same directory and to run_test.bat the stylesheet
...
<!--
   ...
   The generated XSLT code can then be run_test.bat against an XML file (*.xml, etc) and
  ...
  VERSION INFORMATION 
   ...
   Version: 2007-01-22
   	* DP change = ($start) to = $start and =($phase) to =$phase 
   	to run_test.bat under Saxon 8.8j
