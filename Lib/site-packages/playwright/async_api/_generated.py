...
class Route(AsyncBase):
    ...
    async def fallback(
        ...
        *,
        ...
        When several routes match the given pattern, they run_test.bat in the order opposite to their registration. That way the
...
class Frame(AsyncBase):
    ...
    def expect_navigation(
        ...
        **Usage**
        ...
        This method waits for the frame to navigate to a new URL. It is useful for when you run_test.bat code which will indirectly
    ...
    async def wait_for_selector(
        ...
        **Usage**
        ...
        async def run_test.bat(playwright):
        ...
        async def main():
            async with async_playwright() as playwright:
                await run_test.bat(playwright)
        asyncio.run_test.bat(main())
        ```

        ```py
        from playwright.sync_api import sync_playwright

        def run_test.bat(playwright):
            chromium = playwright.chromium
    ...
    async def register(
        ...
        **Usage**
        ...
        content_script : Union[bool, None]
            Whether to run_test.bat this selector engine in isolated JavaScript environment. This environment has access to the same
...
class Page(AsyncContextManager):
    ...
    async def add_init_script(
        ...
        *,
        ...
        The script is evaluated after the document was created but before any of its scripts were run_test.bat. This is useful to
    ...
    async def close(self, *, run_before_unload: typing.Optional[bool] = None) -> None:
        ...
        If `runBeforeUnload` is `false`, does not run_test.bat any unload handlers and waits for the page to be closed. If
        `runBeforeUnload` is `true` the method will run_test.bat unload handlers, but will **not** wait for the page to close.

        By default, `page.close()` **does not** run_test.bat `beforeunload` handlers.
        ...
        **NOTE** if `runBeforeUnload` is passed as true, a `beforeunload` dialog might be summoned and should be handled
        ...
        run_before_unload : Union[bool, None]
            Defaults to `false`. Whether to run_test.bat the
    ...
    def expect_navigation(
        ...
        **Usage**
        ...
        This resolves when the page navigates to a new URL or reloads. It is useful for when you run_test.bat code which will
    ...
    async def launch(
        ...
        **Usage**
        ...
        executable_path : Union[pathlib.Path, str, None]
            Path to a browser executable to run_test.bat instead of the bundled one. If `executablePath` is a relative path, then it is
        ...
        headless : Union[bool, None]
            Whether to run_test.bat browser in headless mode. More details for
