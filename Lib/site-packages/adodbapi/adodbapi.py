...
This module source should run_test.bat correctly in CPython versions 2.7 and later,
...
if __name__ == "__main__":
    raise api.ProgrammingError(version + " cannot be run_test.bat as a main program.")
