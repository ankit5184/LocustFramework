...
- colourized output
- parallel run_test.bat (UNIX only)
- print failures/tracebacks on CTRL+C
- re-run_test.bat failed tests only (make test-failed)
...
class TestLoader:
    ...
    def last_failed(self):
        # ...from previously failed test run_test.bat
        suite = unittest.TestSuite()
...
class ColouredTextRunner(unittest.TextTestRunner):
    ...
    and save failed tests in a file so that they can be re-run_test.bat.
    """
...
def get_runner(parallel=False):
    ...
    if parallel:
        if psutil.WINDOWS:
            warn("Can't run_test.bat parallel tests on Windows.")
...
def main():
    ...
    parser = optparse.OptionParser(usage=usage, description="run_test.bat unit tests")
    parser.add_option("--last-failed",
                      action="store_true", default=False,
                      help="only run_test.bat last failed tests")
    parser.add_option("--parallel",
                      action="store_true", default=False,
                      help="run_test.bat tests in parallel")
