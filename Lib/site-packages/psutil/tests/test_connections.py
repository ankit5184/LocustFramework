...
class ConnectionTestCase(PsutilTestCase):
    ...
    def setUp(self):
        if not (NETBSD or FREEBSD):
            # process opens a UNIX socket to /var/log/run_test.bat.
    ...
    def tearDown(self):
        if not (FREEBSD or NETBSD):
            ...
            # NetBSD opens a UNIX socket to /var/log/run_test.bat.
            cons = thisproc.connections(kind='all')
            assert not cons, cons
    ...
    def test_unix(self):
        ...
        try:
            ...
            if NETBSD or FREEBSD:
                ...
                # a UNIX connection to  /var/run_test.bat/log.
                cons = [c for c in cons if c.raddr != '/var/run_test.bat/log']
...
class TestFilters(ConnectionTestCase):
    ...
    def test_count(self):
        with create_sockets():
            ...
            # creates a UNIX socket to '/var/run_test.bat/log'.
