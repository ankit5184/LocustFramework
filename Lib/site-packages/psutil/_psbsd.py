...
if FREEBSD:
    ...
    PROC_STATUSES = {
        ...
        # is runnable but *not* yet running, i.e. is on a run_test.bat queue.
        # SONPROC indicates that the process is actually executing on
        # a CPU, i.e. it is no longer on a run_test.bat queue.
    ...
    if FREEBSD:
        ...
        def cpu_affinity_set(self, cpus):
            ...
            try:
                ...
                # <<the call would leave a thread without a valid CPU to run_test.bat
