...
# - ... repeat until we run_test.bat out of IPs.
#
...
# multiple connections to the same host it'll re-run_test.bat the happy-eyeballs
    ...
    async def attempt_connect(socket_args, sockaddr, attempt_failed):
        ...
        try:
            ...
            if local_address is not None:
                ...
                # more likely to run_test.bat out of local ports.
                #
