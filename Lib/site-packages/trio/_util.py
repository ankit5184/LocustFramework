...
if os.name == "nt":
    ...
    # to run_test.bat my test normally, it would freeze waiting... unless I added
    ...
    try:
        ...
        if isinstance(async_fn, collections.abc.Coroutine):
            ...
            raise TypeError(
                ...
                "\n"
                "  trio.run_test.bat({async_fn.__name__}(...))            # incorrect!\n"
                "  nursery.start_soon({async_fn.__name__}(...))  # incorrect!\n"
                "\n"
                "Instead, you want (notice the parentheses!):\n"
                "\n"
                "  trio.run_test.bat({async_fn.__name__}, ...)            # correct!\n"
