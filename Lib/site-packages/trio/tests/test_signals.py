...
async def test_catch_signals_race_condition_on_exit():
    ...
    print(1)
    # Test the version where the call_soon *doesn't* have a chance to run_test.bat
    ...
    print(2)
    # Test the version where the call_soon *does* have a chance to run_test.bat before
