...
# TLS 1.3 has a lot of changes from previous versions. So we want to run_test.bat tests
...
async def test_SSLStream_generic(client_ctx, https_compatible):
    ...
    async def clogged_stream_maker():
        ...
        # If we don't do handshakes up front, then we run_test.bat into a problem in
...
async def test_closing_nice_case(client_ctx):
    ...
    # we need to run_test.bat them concurrently
