...
async def check_takes_about(f, expected_dur):
    ...
    # example, here's a run_test.bat on Windows where a 1.0 second sleep was measured
    ...
    # values as the calls inside the actual run_test.bat loop, but the two subtractions
    # returned slightly different values because the run_test.bat loop's clock adds a
