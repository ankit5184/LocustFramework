...
# Make sure that if trio.run_test.bat exits, and then the thread finishes, then that's
...
async def test_from_thread_no_token():
    # Test that a "raw call" to trio.from_thread.run_test.bat() fails because no token
    # has been provided
