...
class Clock(metaclass=ABCMeta):
    """The interface for custom run_test.bat loop clocks."""
    ...
    def start_clock(self):
        ...
        Called at the beginning of the run_test.bat.
...
class Instrument(metaclass=ABCMeta):
    """The interface for run_test.bat loop instrumentation.
    ...
    def before_run(self):
        """Called at the beginning of :func:`trio.run_test.bat`."""

    def after_run(self):
        """Called just before :func:`trio.run_test.bat` returns."""
    ...
    def before_task_step(self, task):
        ...
        Args:
            task (trio.lowlevel.Task): The task that is about to run_test.bat.

        """

    def after_task_step(self, task):
        """Called when we return to the main run_test.bat loop after a task has yielded.
...
class Listener(AsyncResource, Generic[T_resource]):
    ...
    async def accept(self):
        ...
        be raised from :meth:`accept` – for example, if you run_test.bat out of file
