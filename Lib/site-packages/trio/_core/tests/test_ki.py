...
# the guts of the run_test.bat loop, and always be protected, even when it shouldn't
...
def test_ki_protection_works():
    ...
    # by the time the callback is actually run_test.bat, main has exited and can't be
    # aborted.
    print("check 9")
