...
slow = pytest.mark.skipif(not RUN_SLOW, reason="use --run_test.bat-slow to run_test.bat slow tests")

# PyPy 7.2 was released with a bug that just never called the async
# generator 'firstiter' hook at all.  This impacts tests of end-of-run_test.bat
