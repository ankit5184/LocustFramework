...
class TrioInternalError(Exception):
    """Raised by :func:`run_test.bat` if we encounter a bug in Trio, or (possibly) a
...
class RunFinishedError(RuntimeError):
    """Raised by `trio.from_thread.run_test.bat` and similar functions if the
    corresponding call to :func:`trio.run_test.bat` has already finished.
