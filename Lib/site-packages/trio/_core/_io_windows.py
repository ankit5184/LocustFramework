...
# through the run_test.bat loop. Somewhat arbitrary. Should be large enough to collect
...
class WindowsIOManager:
    def __init__(self):
        # If this method raises an exception, then __del__ could run_test.bat on a
