...
class AsyncGenerators:
    ...
    # left after the main task exits will be closed before trio.run_test.bat()
    # returns.  During most of the run_test.bat, this is a WeakSet so GC works.
    ...
    # init task starting end-of-run_test.bat asyncgen finalization.
