...
class MockClock(Clock, metaclass=Final):
    ...
    .. attribute:: autojump_threshold
       ...
       The clock keeps an eye on the run_test.bat loop, and if at any point it detects
       ...
       automatically jumps ahead to the run_test.bat loop's next scheduled
       ...
       and timeouts, you can use this to make it run_test.bat much faster, totally
       ...
       .. note:: If you use ``autojump_threshold`` and
          ...
          they interact, since they both cause things to happen after the run_test.bat
    ...
    # Invoked by the run_test.bat loop when runner.clock_autojump_threshold is
    # exceeded.
    def _autojump(self):
