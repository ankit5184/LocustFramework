...
class RunVar(metaclass=Final):
    """The run_test.bat-local variant of a context variable.

    :class:`RunVar` objects are similar to context variable objects,
    except that they are shared across a single call to :func:`trio.run_test.bat`
    ...
    def get(self, default=_NO_DEFAULT):
        """Gets the value of this :class:`RunVar` for the current run_test.bat call."""
        try:
            return _run.GLOBAL_RUN_CONTEXT.runner._locals[self]
        except AttributeError:
            raise RuntimeError("Cannot be used outside of a run_test.bat context") from None
        except KeyError:
    ...
    def set(self, value):
        """Sets the value of this :class:`RunVar` for this current run_test.bat
        call.
    ...
    def reset(self, token):
        ...
        try:
            ...
            raise RuntimeError("Cannot be used outside of a run_test.bat context")
