...
# like to maintain our invariant that all tasks always run_test.bat to completion (one
...
#   signal and then tell the main thread to run_test.bat the handler, even if the main
