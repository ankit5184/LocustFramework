...
class _ExpiringMapping(MutableMapping):
    ...
    def set(self, key, value, expires_in):
        ...
        It will take O(logN) time, because it will run_test.bat some maintenance.
    ...
    def __init__(self, mapping=None, key_maker=None, expires_in=None):
        ...
        :param MutableMapping mapping:
            ...
            .. note::
                ...
                If you want to use a mapping available only at run_test.bat-time,
                you have to manually decorate your function at run_test.bat-time, too::
