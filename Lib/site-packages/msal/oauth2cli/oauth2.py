...
class Client(BaseClient):  # We choose to implement all 4 grants in 1 class
    ...
    def _obtain_token_by_device_flow(self, flow, **kwargs):
        # type: (dict, **dict) -> dict
        # This method updates flow during each run_test.bat. And it is non-blocking.
        now = time.time()
        skew = 1
    ...
    def obtain_token_by_device_flow(self,
        ...
        Args:
            flow (dict):
                ...
                Its content WILL BE CHANGED by this method during each run_test.bat.
            ...
            exit_condition (Callable):
                ...
                The default callback makes the loop run_test.bat until the flow expires.
                ...
                to make the loop run_test.bat only once, i.e. no polling, hence non-block.
        """
        while True:
