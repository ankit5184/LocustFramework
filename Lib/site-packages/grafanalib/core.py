...
class Svg(Panel):
    ...
    :param format: defines value units
    :param jsCodeFilePath: path to javascript file to be run_test.bat on dashboard refresh
    :param jsCodeInitFilePath: path to javascript file to be run_test.bat after the first initialization of the SVG
