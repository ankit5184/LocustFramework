...
Description
  This file manages the cache of generated Python code.  When run_test.bat from the
    ...
    try:
        ...
        if module is not None and bValidateFile:
            ...
            try:
                ...
                # run_test.bat with what we have though - the typelib may not be
                # deployed here.
                bValidateFile = 0
        if module is not None and bValidateFile:
            assert not is_readonly, "Can't validate in a read-only gencache"
...
def EnsureDispatch(
    ...
    if not disp.__dict__.get("CLSID"):  # Eeek - no makepy support - try and build it.
        try:
            ...
            raise TypeError(
                "This COM object can not automate the makepy process - please run_test.bat makepy manually for this object"
            )
    return disp
