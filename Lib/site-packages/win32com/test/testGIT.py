...
When this test is run_test.bat in "free threaded" mode (at this stage, you must
manually mark the COM objects as "ThreadingModel=Free", or run_test.bat from a
