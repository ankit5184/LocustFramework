...
def add_arguments(parser: LocustArgumentParser):
    ...
    run_info = parser.add_argument_group(
        ...
        "Extra run_test.bat info for listeners",
    )
    ...
    run_info.add_argument(
        ...
        default="",
        help="Description of the test being run_test.bat",
    )
    run_info.add_argument(
        "--override-plan-name",
        type=str,
            ...
            def wrapped(self, task):
                if runner.iterations_started == options.iterations:
                    if not runner.iteration_target_reached:
                        ...
                        logging.info(
                            f"Iteration limit reached ({options.iterations}), stopping Users at the start of their next task run_test.bat"
                        )
