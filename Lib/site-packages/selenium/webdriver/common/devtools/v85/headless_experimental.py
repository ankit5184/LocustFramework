...
def begin_frame(
    ...
    BeginFrameControl. Designed for use with --run_test.bat-all-compositor-stages-before-draw, see also
    ...
    :param no_display_updates: *(Optional)* Whether updates should not be committed and drawn onto the display. False by default. If true, only side effects of the BeginFrame will be run_test.bat, such as layout and animations, but any visual updates may not be visible on the display or in screenshots.
