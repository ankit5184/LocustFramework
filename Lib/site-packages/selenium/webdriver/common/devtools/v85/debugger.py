...
def set_script_source(
    ...
    :param dry_run: *(Optional)* If true the change will not actually be applied. Dry run_test.bat may be used to get result description without actually modifying the code.
    :returns: A tuple with the following items:
