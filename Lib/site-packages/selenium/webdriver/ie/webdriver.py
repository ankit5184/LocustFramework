...
class WebDriver(RemoteWebDriver):
    ...
    def __init__(
        ...
        :Args:
         ...
         - port - Deprecated: port you would like the service to run_test.bat, if left as 0, a free port will be found.
         - timeout - Deprecated: no longer used, kept for backward compatibility
         - host - Deprecated: IP address for the service
         - log_level - Deprecated: log level you would like the service to run_test.bat.
