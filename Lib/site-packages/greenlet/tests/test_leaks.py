...
class TestLeaks(TestCase):
    ...
    def _check_issue251(self,
        ...
        # run_test.bat results in all callers failing the leaktest; that
        # greenlet instance is leaked. There's a bound method for
        # run_test.bat() living on the stack of the greenlet in g_initialstub,
        ...
        def background_thread():
            ...
            # need to run_test.bat some APIs. See issue 252.
    ...
    def _only_test_some_versions(self):
        ...
        # OS and memory management details. So we want to run_test.bat it on 3.11+
