...
class TestTrashCanReEnter(unittest.TestCase):
    ...
    def check_it(self): # pylint:disable=too-many-statements
        ...
        class Dealloc: # define the class here because we alter class variables each time we run_test.bat.
            """
            An object with a ``__del__`` method. When it starts getting deallocated
            from a deferred trash can run_test.bat, it switches greenlets, allocates more objects
            ...
            #: Has our deallocation actually run_test.bat and switched greenlets?
            ...
            #: Has the background greenlet run_test.bat?
            BG_RAN = False
            ...
            def __init__(self, sequence_number):
                ...
                :param sequence_number: The ordinal of this object during
                   one particular creation run_test.bat. This is used to detect (guess, really)
