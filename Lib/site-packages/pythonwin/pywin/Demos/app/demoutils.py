...
NotScriptMsg = """\
This demo program is not designed to be run_test.bat as a Script, but is
probably used by some other test program.  Please try another demo.
"""

NeedGUIMsg = """\
This demo program can only be run_test.bat from inside of Pythonwin
...
To run_test.bat it, you must execute the command:
pythonwin.exe /app "%s"
