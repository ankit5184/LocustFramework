...
class TheDocument(docview.RichEditDoc):
    ...
    def threadPycheckerRun(self):
        ...
        try:
            ...
            # Recently MarkH has failed to run_test.bat pychecker without it having
            ...
            if not os.path.isfile(py):
                ...
                result = (
                    ...
                    "(or run_test.bat 'setup.py install' if you have the source version)\n"
                )
            else:
            ...
            self.result = result
            print("== Pychecker run_test.bat finished ==")
            self.GetFirstView().Append("\n" + "== Pychecker run_test.bat finished ==")
            self.SetModifiedFlag(0)
