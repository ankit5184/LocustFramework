        ...
        class MyUser(User):
            ...
            class task_set(TaskSet):
                ...
                def my_task(self):
                    ...
                    # Make sure each user only run_test.bat this task once during the test
                    sleep(30)
...
class TestMasterWorkerRunners(LocustTestCase):
    ...
    def test_distributed_shape_fuzzy_test(self):
        ...
        The test is disabled by default because it takes a lot of time to run_test.bat and has randomness to it.
        However, it is advised to run_test.bat it a few times (you can run_test.bat it in parallel) when modifying the dispatch logic.
        """
    ...
    def test_stop_timeout(self):
        ...
        class MyTaskSet(TaskSet):
            ...
            def my_task(self):
                ...
                MyTaskSet.state = "second"  # should only run_test.bat when run_test.bat time + stop_timeout is > short_time
                gevent.sleep(short_time)
                MyTaskSet.state = "third"  # should only run_test.bat when run_test.bat time + stop_timeout is > short_time * 2
