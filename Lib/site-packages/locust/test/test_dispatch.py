...
@unittest.skip(reason="takes too long. run_test.bat this manually if you change dispatch logic.")
...
class TestLargeScale(unittest.TestCase):
    ...
    def test_distribute_users(self):
        for user_classes in [self.weighted_user_classes, self.fixed_user_classes_1M, self.mixed_users]:
            ...
            # Because tests are run_test.bat with coverage, the code will be slower.
