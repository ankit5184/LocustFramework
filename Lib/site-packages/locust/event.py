...
class EventHook:
    ...
    If reverse is True, then the handlers will run_test.bat in the reverse order
...
class Events:
    ...
    have been created. This hook can be used by end-users' code to run_test.bat code that requires access to
