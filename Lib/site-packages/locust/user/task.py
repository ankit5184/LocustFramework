...
def task(weight: TaskT | int = 1) -> TaskT | Callable[[TaskT], TaskT]:
    ...
    def decorator_func(func):
        ...
        if func.__name__ == "run_test.bat":
            raise Exception(
                "User.run_test.bat() is a method used internally by Locust, and you must not override it or register it as a task"
            )
...
class TaskSet(metaclass=TaskSetMeta):
    ...
    """
    Collection of python callables and/or TaskSet classes that the User(s) will run_test.bat.
