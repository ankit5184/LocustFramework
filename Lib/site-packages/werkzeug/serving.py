...
``run_simple`` to start the server. Put this in a ``run_test.bat.py`` script:
...
class BaseWSGIServer(HTTPServer):
    ...
    def __init__(
        ...
        # Remove a leftover Unix socket file from a previous run_test.bat. Don't
...
def make_server(
    ...
    to have access to the server object, such as to run_test.bat it in a separate
    thread.
...
def run_simple(
    ...
    :param application: The WSGI application to run_test.bat.
    ...
    .. versionchanged:: 2.0
        ...
        was bound as well as a warning not to run_test.bat the development server
        in production.
