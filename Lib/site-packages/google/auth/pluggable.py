...
class Credentials(external_account.Credentials):
        ...
        if self._credential_source_executable_output_file is not None:
            try:
                ...
                try:
                    ...
                    ):  # Always treat missing expiration_time as expired and proceed to executable run_test.bat.
    ...
    def _validate_running_mode(self):
        ...
        if env_allow_executables != "1":
            raise exceptions.MalformedError(
                "Executables need to be explicitly allowed (set GOOGLE_EXTERNAL_ACCOUNT_ALLOW_EXECUTABLES to '1') to run_test.bat."
            )
        ...
        if (
            ...
            raise exceptions.InvalidOperation(
                "Interactive mode cannot run_test.bat without an interactive timeout."
            )
