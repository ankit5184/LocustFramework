...
# challenges should be run_test.bat.
...
def _run_next_challenge(msg, request, access_token):
    """Get the next challenge from msg and run_test.bat it.
    ...
    if (
        ...
        if not enable_reauth_refresh:
            raise exceptions.RefreshError(
                "Reauthentication is needed. Please run_test.bat `gcloud auth application-default login` to reauthenticate."
            )
