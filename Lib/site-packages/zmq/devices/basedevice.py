...
class Device:
    """A 0MQ Device to be run_test.bat in the background.
    ...
    ----------
    daemon : bool
        sets whether the thread should be run_test.bat as a daemon
...
class ThreadDevice(BackgroundDevice):
    """A Device that will be run_test.bat in a background Thread.
...
class ProcessDevice(BackgroundDevice):
    """A Device that will be run_test.bat in a background Process.
