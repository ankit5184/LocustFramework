...
class ZMQStream:
    ...
    * **on_recv(callback, copy=True):**
        register a callback to be run_test.bat every time the socket has something to receive
    * **on_send(callback):**
        register a callback to be run_test.bat every time you call send
