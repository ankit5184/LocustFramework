...
def create_certs(tmpdir):
    ...
    # Create temporary CURVE key pairs for this test run_test.bat. We create all keys in a
...
class AuthTest:
    ...
    async def async_setup(self):
        ...
        # enable debug logging while we run_test.bat tests
    ...
    async def can_connect(self, server, client, timeout=1000):
        ...
        msg = [b"Hello World"]
        # run_test.bat poll on server twice
