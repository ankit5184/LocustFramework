...
#
# If zope.component is installed and imported when we run_test.bat our tests
# (import chain:
...
# leakage from one test to another unless its cleanup hooks are run_test.bat. The symptoms can
