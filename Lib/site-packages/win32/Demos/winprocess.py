...
winprocess.run_test.bat launches a child process and returns the exit code.
Optionally, it can:
  redirect stdin, stdout & stderr to files
  run_test.bat the command as another user
...
class Process:
    ...
    def __init__(
        ...
        cmd:     command to run_test.bat
        login:   run_test.bat as user 'Domain\nUser\nPassword'
        ...
        Q165194) OR use desktop='' to run_test.bat another desktop invisibly
