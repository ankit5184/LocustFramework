...
# and for for Python programs which run_test.bat as services...
#
...
def LocatePythonServiceExe(exe=None):
    ...
    # pywin32 installed it next to win32service.pyd (but we can't run_test.bat it from there)
    ...
    # there's a good chance the service will not run_test.bat. That's usually copied by
...
def usage():
    ...
    print(" --username domain\\username : The Username the service is to run_test.bat under")
