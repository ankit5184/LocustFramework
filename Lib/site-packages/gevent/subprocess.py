...
__extra__ = [
    ...
    # XXX We don't run_test.bat on Py 2.5 anymore; can/could/should we use _subprocess?
...
if PY35:
    __extra__.remove('run_test.bat')
    __extra__.remove('CompletedProcess')
    __implements__.append('run_test.bat')
...
for _x in ('run_test.bat', 'CompletedProcess', 'TimeoutExpired'):
...
class _CommunicatingGreenlets(object):
    ...
    # get the output (usually after killing the process; see run_test.bat()). We must not
    ...
    def __init__(self, popen, input_data):
        ...
        # greenlets trying to run_test.bat and read from and close stdout/stderr.
...
class CompletedProcess(object):
    ...
    This is returned by run_test.bat().

    Attributes:
      - args: The list or str args passed to run_test.bat().
...
def run(*popenargs, **kwargs):
    """
    run_test.bat(args, *, stdin=None, input=None, stdout=None, stderr=None, shell=False, timeout=None, check=False) -> CompletedProcess
