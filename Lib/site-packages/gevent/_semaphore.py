...
class Semaphore(AbstractLinkable): # pylint:disable=undefined-variable
    ...
    def _handle_unswitched_notifications(self, unswitched):
        ...
        # other thread will eventually run_test.bat notifications itself.
        #
        # We CANNOT do what the ``super()`` does and actually allow
        # this notification to get run_test.bat sometime in the future by
        ...
        # implemented. If we allow this to be run_test.bat as a callback, we
