...
class Event(AbstractLinkable): # pylint:disable=undefined-variable
    ...
    .. note::
        ...
        Once the event is set, other greenlets may run_test.bat before any waiting greenlets
        are awakened.
    ...
    .. versionchanged:: 20.5.1
        ...
        Callers to ``wait`` that find the event already set will now run_test.bat
...
class AsyncResult(AbstractLinkable): # pylint:disable=undefined-variable
    ...
    .. note::
        ...
        (those not waiting to be awakened) may run_test.bat between the current greenlet yielding and
