...
# But if we're run_test.bat standalone, default to false
...
class ExampleMixin(object):
    ...
    #: Keyword arguments to pass to the start or run_test.bat method.
    start_kwargs = None
    ...
    def cwd(self):
        try:
            ...
            raise unittest.SkipTest("Unable to locate file/dir to run_test.bat: %s" % (e,))
    ...
    def setenv(self):
        ...
        Since the child is run_test.bat in `cwd`, relative paths in ``PYTHONPATH``
    ...
    def run_example(self):# run_test.bat() is a unittest method.
