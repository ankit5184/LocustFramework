...
if OSX:
    disabled_tests += [
        # These are timing dependent, and sometimes run_test.bat into the OS X
...
if PY2 and PYPY:
    disabled_tests += [
        ...
        # are also too new to run_test.bat on PyPy).
...
if PYPY and PY3:
    ...
    disabled_tests += [
        ...
        # when run_test.bat by the testrunner, not when run_test.bat manually on the command line,
...
if PY37:
    disabled_tests += [
        ...
        # but it passes when they run_test.bat it and fails when we do. It's not
        # clear why.
