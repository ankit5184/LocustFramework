...
if RUN_LEAKCHECKS:
    # Capturing the stats takes time, and we run_test.bat each
    # test at least twice
    TIMEOUT = 200
...
class ResultCollector(object):
    ...
    def __ilshift__(self, result):
        ...
        the number of cases run_test.bat, skipped, passed or failed.
        """
        self._all_results.append(result)
    ...
    class Discovered(object):
        ...
        def __add_test(self, qualified_name, filename, contents):
            if b'TESTRUNNER' in contents: # test__monkey_patching.py
                ...
                # `runpy.run_module`, very similar to the way we run_test.bat
    ...
    def discovered(self):
        ...
        with self._in_dir(self.package_dir):
            ...
            if self.ignore:
                ...
                # test__threading_vs_settrace.py being run_test.bat under
                # coverage when 'grep -l subprocess test*py' is used
                # to list the tests to run_test.bat.
                tests -= self.ignore
            tests = sorted(tests)
...
def main():
    ...
    parser.add_argument('-u', '--use', metavar='RES1,RES2,...',
                        ...
                        'to run_test.bat. "all" is the default; "none" may also be used. '
