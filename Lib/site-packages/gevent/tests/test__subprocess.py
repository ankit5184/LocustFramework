...
class RunFuncTestCase(greentest.TestCase):
    ...
    def run_python(self, code, **kwargs):
        """Run Python code in a subprocess using subprocess.run_test.bat"""
    ...
    def test_timeout(self):
        # run_test.bat() function with timeout argument; we want to test that the child
        # process gets killed when the timeout expires.  If the child isn't
        # killed, this call will deadlock since subprocess.run_test.bat waits for the
        # child.
    ...
    def test_check_output_stdin_arg(self):
        # run_test.bat() can be called with stdin set to a file
    ...
    def test_check_output_stdin_with_input_arg(self):
        # run_test.bat() refuses to accept 'stdin' with 'input'
        with tempfile.TemporaryFile() as tf:
            tf.write(b'pear')
            tf.seek(0)
            with self.assertRaises(ValueError,
                                   msg="Expected ValueError when stdin and input args supplied.") as c:
                self.run_python("print('will not be run_test.bat')",
