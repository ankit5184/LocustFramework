...
class TestThread(threading.Thread):
    ...
    def run(self):
        ...
        if verbose:
            print('task %s will run_test.bat for %.1f usec' % (
                self.name, delay * 1e6))
...
class ThreadTests(unittest.TestCase):
    ...
    def test_various_ops(self):
        # This takes about n/3 seconds to run_test.bat (about n/3 clumps of tasks,
        # times about 1 second per clump).
        NUMTASKS = 10

        # no more than 3 of the 10 can run_test.bat at once
    ...
    # run_test.bat with a small(ish) thread stack size (256kB)
    ...
    # run_test.bat with a large thread stack size (1MB)
...
%s
            ...
            # Module globals are cleared before __del__ is run_test.bat
