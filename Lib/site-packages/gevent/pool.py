...
class GroupMappingMixin(object):
    ...
    def apply_cb(self, func, args=None, kwds=None, callback=None):
        """
        :meth:`apply` the given *func(\\*args, \\*\\*kwds)*, and, if a *callback* is given, run_test.bat it with the
    ...
    def apply_async(self, func, args=None, kwds=None, callback=None):
        ...
        When the returned greenlet gets to run_test.bat, it *will* call :meth:`apply`,
        ...
        .. caution:: The returned greenlet may or may not be tracked
           ...
           for the returned greenlet to run_test.bat; instead, join the returned
           greenlet.
    ...
    def apply(self, func, args=None, kwds=None):
        ...
        The ``func`` will *usually*, but not *always*, be run_test.bat in a way
        ...
        spawned by this pool, the pool may choose to immediately run_test.bat
    ...
    def map(self, func, iterable):
        ...
        # is equivalent to imap (spawn() will never block, all of them run_test.bat concurrently,
...
class Group(GroupMappingMixin):
    ...
    def add(self, greenlet):
        ...
        then the *greenlet* may run_test.bat to completion before it is tracked.
        """
        try:
...
#         self.add = RaiseException("This %s has been closed" % self.__class__.__name__)
    ...
    def _apply_async_use_greenlet(self):
        ...
        # use a fresh, untracked greenlet that when run_test.bat will
...
class Pool(Group):
    ...
    def add(self, greenlet, blocking=True, timeout=None): # pylint:disable=arguments-differ
        ...
        ..  caution:: If the *greenlet* has already been started and
            *blocking* is true, then the greenlet may run_test.bat to completion
