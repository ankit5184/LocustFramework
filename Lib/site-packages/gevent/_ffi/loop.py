...
class AbstractLoop(object):
    ...
    # How many callbacks we should run_test.bat between checking against the
    # switch interval.
    ...
    def _init_loop_and_aux_watchers(self, flags=None, default=None):
        ...
        # signals. It doesn't run_test.bat watchers or callbacks, it just exists to give
        ...
        # just before the blocking call. It's where we run_test.bat deferred callbacks
        ...
        # too many to run_test.bat in one iteration of _run_callbacks, we turn this
        # on so as to have the next iteration of the run_test.bat loop return to us
    ...
    def _run_callbacks(self): # pylint:disable=too-many-branches
        ...
        # run_test.bat; this is mostly an issue for libuv).
        ...
        try:
            ...
            while self._callbacks:
                ...
                try:
                    ...
                    # the loop won't run_test.bat. The second is that any remaining callbacks scheduled
                    # for this loop iteration will be silently dropped; they won't run_test.bat, but they'll
                    ...
                    # to run_test.bat the callback, which uses gevent_handle_error to handle any errors the
                    ...
                    # the callback class so that bool(cb) of a callback that has been run_test.bat
                    # becomes False
                    cb.args = None
