...
class TransactionOptions(object):
    ...
    :Parameters:
      ...
      - `max_commit_time_ms` (optional): The maximum amount of time to allow a
        single commitTransaction command to run_test.bat. This option is an alias for
...
class ClientSession:
    ...
    :class:`ClientSession` cannot be used to run_test.bat multiple operations
    concurrently.
    ...
    def with_transaction(
        ...
        should simply run_test.bat operations meant to be contained within a
        ...
        :Parameters:
          - `callback`: The callable ``callback`` to run_test.bat inside a transaction.
            The callable must accept a single argument, this session. Note,
            under certain error conditions the callback may be run_test.bat multiple
            times.
          - `read_concern` (optional): The
    ...
    def _process_response(self, reply):
        """Process a response to a command that was run_test.bat with this session."""
