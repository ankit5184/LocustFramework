...
The declared API version is applied to all commands run_test.bat through ``client``,
...
To run_test.bat any command without declaring a server API version or using a different
