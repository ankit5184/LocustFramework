...
class MongoClient(common.BaseObject, Generic[_DocumentType]):
    ...
    def _select_server(self, server_selector, session, address=None):
        """Select a server to run_test.bat an operation on this client.
    ...
    # This method is run_test.bat periodically by a background thread.
    ...
    def start_session(
        ...
        **not thread-safe or fork-safe**. They can only be used by one thread
        ...
        to run_test.bat multiple operations concurrently.
...
if _HAS_REGISTER_AT_FORK:
    # This will run_test.bat in the same thread as the fork was called.
