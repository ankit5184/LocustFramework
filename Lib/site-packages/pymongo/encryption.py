...
class _EncryptionIO(MongoCryptCallback):  # type: ignore
    ...
    def collection_info(self, database, filter):
        ...
        :Parameters:
          - `database`: The database on which to run_test.bat listCollections.
    ...
    def mark_command(self, database, cmd):
        ...
        :Parameters:
          - `database`: The database on which to run_test.bat this command.
          - `cmd`: The BSON command to run_test.bat.
