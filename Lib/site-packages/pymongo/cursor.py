...
class Cursor(Generic[_DocumentType]):
    ...
    def __die(self, synchronous=False):
        ...
        try:
            ...
            # __init__ did not run_test.bat to completion (or at all).
            return
    ...
    def __getitem__(self, index):
        ...
        .. warning:: A :class:`~Cursor` is not a Python :class:`list`. Each
          index access or slice requires that a new query be run_test.bat using skip
    ...
    def explain(self) -> _DocumentType:
        ...
        .. note:: This method uses the default verbosity mode of the
          ...
          :meth:`~pymongo.database.Database.command` to run_test.bat the explain
          command directly.
