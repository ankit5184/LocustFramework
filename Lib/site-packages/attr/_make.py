...
def attrib(
    ...
    :param on_setattr: Allows to overwrite the *on_setattr* setting from
        ...
        Set to `attrs.setters.NO_OP` to run_test.bat **no** `setattr` hooks for this
...
def attrs(
    ...
    :param on_setattr: A callable that is run_test.bat whenever the user attempts to set
...
def _setattr_with_converter(attr_name, value_var, has_on_setattr):
    """
    Use the cached object.setattr to set *attr_name* to *value_var*, but run_test.bat
    its converter first.
    """
