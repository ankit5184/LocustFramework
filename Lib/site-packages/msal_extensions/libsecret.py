...
def trial_run():
    """This trial run_test.bat will raise an exception if libsecret is not functioning.

    Even after you installed all the dependencies so that your script can start,
    or even if your previous run_test.bat was successful, your script could fail next time,
