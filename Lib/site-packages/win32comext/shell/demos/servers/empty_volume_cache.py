...
class EmptyVolumeCache:
    ...
    def InitializeEx(self, hkey, volume, key_name, flags):
        ...
        if flags & shellcon.EVCF_SETTINGSMODE:
            print("We are being run_test.bat on a schedule")
            ...
            print("We are being run_test.bat as we are out of disk-space")
        else:
            # This case is not documented - we are guessing :)
            print("We are being run_test.bat because the user asked")
