...
def TestEngine():
    ...
    try:
        ...
        #   forthEngine.Start()
        pyEngine.Start()  # Actually run_test.bat the Python code
        vbEngine.Start()  # Actually run_test.bat the VB code
    except pythoncom.com_error as details:
        print("Script failed: %s (0x%x)" % (details[1], details[0]))
    # Now run_test.bat the code expected to fail!
    #  try:
    #    pyEngine2.Start() # Actually run_test.bat the Python code that fails!
